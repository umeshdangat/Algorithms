public class WordNetTest {
    ...
    public static void testStandardChecklist(WordNet wordnet) {
        ...
        if (!wordnet.sap("individual", "edible_fruit").equals("physical_entity")) {
    ...
    public static void testExtraTests(WordNet wordnet) {
        ...
        StdOut.printf("Length errors: %d SAP errors: %d\n", length_errors, ancestor_errors);
       
    }
 
    public static void main(String[] args) {
        WordNet wordnet = testConstruction("synsets.txt", "hypernyms.txt");
